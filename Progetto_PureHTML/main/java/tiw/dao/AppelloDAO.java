...
public class AppelloDAO {
	...
	public void UpdateVotoStud(int selectedAppelloId, int idstudente, String votoStr) throws SQLException {
		...
		try {
			...
			if (!"pubblicato".equals(statoValutazione) && !"verbalizzato".equals(statoValutazione) && !"rifiutato".equals(statoValutazione) ) {
				if (votoStr.equals(" ")) {
				...
				throw new SQLException("Update is not allowed for entries with stato di valutazione: pubblicato, verbalizzato, rifiutato ");
			}
